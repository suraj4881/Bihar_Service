...
import { sewaPageBg, sewaPageBgOverlay, sewaAuthBrandPanel, sewaPrimaryButtonGradient, sewaPrimaryButtonHover } from '../theme/sewaDesign';
  ...
  return (
    ...
    >
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        <Grid container spacing={0} sx={{ minHeight: { xs: 'auto', md: 560 } }}>
          {/* Left Panel - Branding */}
          <Grid
            item
            xs={12}
            md={6}
            sx={{
              background: sewaAuthBrandPanel(mode),
            ...
            <Typography 
              ...
              sx={{ 
                ...
                background: mode === 'dark'
                  ? 'linear-gradient(135deg, #B2DFDB 0%, #ffffff 100%)'
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <CardContent sx={{ p: { xs: 3, sm: 5, md: 6 }, height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Typography 
                  variant="h4" 
                  sx={{ 
                    fontWeight: 800, 
                    ...
                    disabled={loading}
                      ...
                      '&:hover': {
                        ...
                        transform: 'translateY(-2px)',
                          boxShadow: '0 12px 28px rgba(0, 77, 64, 0.4)',
                      },
                      '&:disabled': {
