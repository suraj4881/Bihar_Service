...
public class AdminController {
    ...
    /**
     * Same payload as {@link #getDashboardStats()} at {@code GET /api/admin/stats} (short path).
     */
    @GetMapping("/stats")
    public ResponseEntity<ApiResponse> getAdminStatsShort() {
        return dashboardStatsResponse();
    }

    private ResponseEntity<ApiResponse> dashboardStatsResponse() {
        try {
